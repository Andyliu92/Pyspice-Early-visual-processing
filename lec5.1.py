'''
Content:
    1. Using Separate Device Models
        why using ?
        - to avoid getting a confusing netlist
        - build a library of devices and just import them when using.

        usually stored in a .lib file
        often, manufactures will publish their SPICE lib
        1 lib can contain more than 1 kind of model
'''
